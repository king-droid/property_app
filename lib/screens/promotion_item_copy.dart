...
class PromotionItemCopy extends StatefulWidget {
  Promotion? promotion;
  ...
  @override
  _PromotionItemCopyState createState() => _PromotionItemCopyState();
}

class _PromotionItemCopyState extends State<PromotionItemCopy> {
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.pushNamed(
                                ...
                                arguments: widget.promotion?.userId ?? "");
                          },
                          child: Container(
                            child: (widget.promotion?.profilePic ?? "")
                                    .isNotEmpty
                                ? Container(
                                    child: CircleAvatar(
                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      if ((user?.accountType ==
                                        ...
                                        if ((widget.promotion?.userId ?? "") ==
                                            (user?.userId ?? "")) {
                                          Navigator.pushNamed(
                                              context,
                                              AppRoutes
                                                  .promotionInterestsScreen,
                                ...
                                child: GestureDetector(
                                  onTap: () async {
                                    ...
                                    if (promotion != null) {
                                      ...
                                      widget.promotionRefreshCallback
                                          .call(true);
                                    }
                                  },
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: <Widget>[
                                        ...
                                        Container(
                                          margin: EdgeInsets.only(left: 5),
                                          child: Text(
                                            (widget.promotion?.promotionCommentsCount ??
                                                            "0") ==
                                                        "1" ||
                                                    (widget.promotion
                                                                ?.promotionCommentsCount ??
                                                            "0") ==
                                                        "0"
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        Navigator.pushNamed(context,
                                            AppRoutes.promotionViewsScreen,
                                            arguments: widget.promotion);
                                      },
                                      child: Container(
                                        color: Colors.transparent,
                                        ...
                                        child: Text(
                                            (widget.promotion?.promotionViewsCount ??
                                                            "0") ==
                                                        "1" ||
                                                    (widget.promotion
                                                                ?.promotionViewsCount ??
