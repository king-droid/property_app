...
class PromotionInterestsScreen extends StatefulWidget {
  @override
  PromotionInterestsScreenState createState() =>
      PromotionInterestsScreenState();
}

class PromotionInterestsScreenState extends State<PromotionInterestsScreen> {
  final bloc = PostBloc();
  Promotion? promotion;
  ...
  void initState() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      BlocProvider.of<GetPostInterestsBloc>(context)
          .add(GetPostInterests(promotion?.promotionId ?? ""));
    });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Promotion Interests",
