...
class NativeAdWidgetOtherProfile extends StatefulWidget {
  double? height;

  NativeAdWidgetOtherProfile({Key? key, @required this.height})
      : super(key: key);

  @override
  _NativeAdWidgetOtherProfileState createState() =>
      _NativeAdWidgetOtherProfileState();
}

class _NativeAdWidgetOtherProfileState
    extends State<NativeAdWidgetOtherProfile> {
  NativeAd? _nativeAd;
  ...
  void initState() {
    ...
    _nativeAd = NativeAd(
      adUnitId: AdHelper.nativeAdWidgetOtherProfile,
      request: AdRequest(),
      listener: NativeAdListener(
        onAdLoaded: (Ad ad) {
